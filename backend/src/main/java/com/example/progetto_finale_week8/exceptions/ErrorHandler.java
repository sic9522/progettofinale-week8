...
public class ErrorHandler {
	...
	// @PreAuthorize che nega l'accesso: chi cambia il prezzo senza essere admin riceve 403
	@ExceptionHandler(AccessDeniedException.class)
	public ResponseEntity<ErrorResponse> handleAccessDenied(AccessDeniedException e) {
		return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new ErrorResponse("Accesso negato"));
	}
